<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="extra.aspx.cs" Inherits="WebApplication1.extra" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Extra Plan</title>
    <style>
        body {
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="outputextra" runat="server" Visible="False" CssClass="output-label"></asp:Label>
        <br />
