...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
            <asp:Button ID="signin" runat="server" Text="login" CssClass="blue-button" OnClick="submit_Click" Style="width: 200px;" />
            <br />
            <br />
            <asp:Button ID="BackButton" runat="server" Text="Back" CssClass="back-button" OnClick="BackButton_Click" Style="width: 200px;" />
            <br />
            <br />
